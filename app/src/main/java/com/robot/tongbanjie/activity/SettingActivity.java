...
import com.robot.tongbanjie.dialog.TradePasswdDialog;
...
public class SettingActivity extends BaseActivity implements OnClickListener {
    ...
    private TradePasswdDialog mTradePasswdDialog;
    ...
    public void initData() {
        ...
        mTradePasswdDialog = new TradePasswdDialog(this);
    }
    ...
    public void setListener() {
        ...
        mTradePasswdDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
            @Override
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.setting_amount_cashed:
                mTradePasswdDialog.show();
                mTradePasswdDialog.getInputPwdView().setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        showKeyBoard();
                    }
                });
                mAccountCashed.post(new Runnable() {
                    @Override
                    public void run() {
                        showKeyBoard();
                    }
    ...
    private void showKeyBoard() {
        if (pwdDialogFragment == null) {
            pwdDialogFragment = PwdDialogFragment.newInstance(SettingActivity.this, null, 0);
            pwdDialogFragment.setOnAddListener(mTradePasswdDialog.getInputPwdView());
            pwdDialogFragment.setOnConfirmListener(mTradePasswdDialog.getInputPwdView());
            pwdDialogFragment.setOnDeleteListener(mTradePasswdDialog.getInputPwdView());
        }
