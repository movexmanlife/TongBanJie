    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        background = new Drawable() {
            ...
            public void draw(Canvas canvas) {
                if (topShader == null) {
                    topShader = new LinearGradient((viewWidth * 2 / 6), obtainSelectedAreaBorder()[0], viewWidth * 4 / 6, obtainSelectedAreaBorder()[0], new int[]{
                            Color.parseColor("#12999999"), Color.parseColor("#56999999"), Color.parseColor("#56999999"), Color.parseColor("#12999999")
                ...
                if (bottomShader == null) {
                    bottomShader = new LinearGradient((viewWidth * 2 / 6), obtainSelectedAreaBorder()[1], viewWidth * 4 / 6, obtainSelectedAreaBorder()[1], new int[]{
                            Color.parseColor("#12999999"), Color.parseColor("#56999999"), Color.parseColor("#56999999"), Color.parseColor("#12999999")
                    }, null, Shader.TileMode.REPEAT);
                }
